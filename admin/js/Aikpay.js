...
$(function(){
	...
	$("#submit_webInfo").click(function(){
		...
		$.ajax({
			...
			data : {"title":web_name,"title2":title2,"web_url":web_url,"description":web_description,"keywords":web_keywords,"zzqq":web_qq,"qun":qun,"qun1":qun1,"notice1":web_notice1,"notice2":web_notice2,"notice3":web_notice3,"foot":web_foot,"showKc":showKc,"dd_notice":dd_notice,"CC_Defender":CC_Defender,"txprotect":txprotect,"qqtz":qqtz},
			dataType : 'json',
			success : function(data) {
				 layer.close(ii);
				if(data.code == 1){
